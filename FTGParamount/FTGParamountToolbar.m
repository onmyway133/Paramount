...
@property (nonatomic, strong, readwrite) FTGParamountToolbarItem *selectItem;
@property (nonatomic, strong, readwrite) FTGParamountToolbarItem *moveItem;
@property (nonatomic, strong, readwrite) FTGParamountToolbarItem *globalsItem;
@property (nonatomic, strong, readwrite) FTGParamountToolbarItem *closeItem;
@property (nonatomic, strong, readwrite) FTGParamountToolbarItem *hierarchyItem;
